...
body {
        background-image: url('frontend/assets/img/watermark.png'); /* Replace 'path/to' with the actual path to your image */
        ...
        background-size: 50% 50%; /* Make the image cover the entire background */
    ...
    <tr>
        ...
        <td align="right">
          <div class="font" style="margin-top: -12px;">
            <h3><span style="color: #106908;">QUOTATION:</span> #{{ $sale->invoice}}</h3>
