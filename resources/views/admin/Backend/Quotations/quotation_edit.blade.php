	  ...
	  <div class="col-lg-12 mb-lg-0 mb-4">
		<div class="card">
		  <div class="card-body p-3">
			...
			<form class="insert-form" id="insert_form" method="post" action="{{ route('quotation.update') }}">
			@csrf
			...
			<div class="row">
				<div class="col">
					<div class="row mb-3">
						...
						<div class="col">
							...
							<option value="{{$quotation->customer_id}}" selected="">{{$quotation->customer->customer_name}}</option>
						...
						<div class="row mb-3">
							...
							<div class="col"><input class="form-control" value="{{$quotation->customer->address}}" type="text" id="address" name="address">
						</div>
							
						</div>
						<div class="row mb-3">
							<div class="col-3"><label class="text-uppercase text-dark text-xs font-weight-bold">Phone</label></div>
							<div class="col"><input value="{{$quotation->customer->phone}}" class="form-control mb-3" type="text" id="phone" name="phone" required=""></div>
				...
				<div class="col">
					<div class="row mb-3">
						...
						<div class="col"><input value="{{$quotation->sale_date}}" class="form-control" type="date" id="saleDate" name="saleDate" required=""></div>
					</div>
					<div class="row mb-3">
						<div class="col-3"><label class="text-uppercase text-dark text-xs font-weight-bold">Expire Date</label></div>
						<div class="col"><input class="form-control" value="{{$quotation->expire_date}}" type="date" id="expDate" name="expDate" required=""></div>
					</div>
					{{-- <div class="row mb-3">
					...
					<div class="row mb-3">
						...
						<div class="col"><textarea class="form-control" name="details" id="details" rows="3">{{$quotation->details}}</textarea></div>
					</div>
					{{-- <div class="row mb-3">
				...
				@foreach ($quotationItems as $item)
					...
					<tr>
						...
						<td>
						  ...
						  <td><input class="form-control total" type="number" id="amount" name="amount[]" value="{{$item->amount}}" readonly></td>
						  <td>
							<a name="add" id="add" class="btn bg-gradient-dark mb-0"><i class="fas fa-plus" aria-hidden="true"></i></a>

							<a name="remove" id="remove" class="btn bg-gradient-danger mb-0"><i class="fas fa-minus" aria-hidden="true"></i></a>
				...
				<hr>
					...
					<div class="col-4">
						...
						<div class="row mb-2">
							...
							<div class="col"><input value="{{$quotation->discount_per}}" class="dper form-control" type="number" id="discount-percentage" name="dper">
							</div>
						</div>
						<div class="row mb-2">
						...
						<div class="row mb-2">
							...
							<div class="col"><input class="form-control" value="{{$quotation->grand_total}}" type="text" name="grandtotal" id="grandtotal" readonly>
							</div>
						</div>
						<div class="row mb-2">
							<div class="col-4"><label class="text-uppercase text-dark text-xs font-weight-bold ">Paid Amount</label></div>
							<div class="col"><input value="{{$quotation->p_paid_amount}}" class="form-control" type="number" name="paidamount" id="paidamount" required>
							</div>
						</div>
						<div class="row mb-2">
			...
			<div class="container">
				<div class="row">
				  ...
				  <div class="col">
					<input type="submit" class="btn bg-gradient-primary w-100" value="Update Quotation">
				  </div>
				  <div class="col">
				  </div>
				</div>
