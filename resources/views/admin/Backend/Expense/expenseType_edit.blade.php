				...
				<div class="box">
					...
					<div class="box-body">
						<div class="table-responsive">
										...
										<form method="post" action="{{ route('expenseType.update') }}">
								@csrf
								<input type="hidden" name="id" value="{{$expenseType->id}}">  
									<div class="form-group">
										<h6>Expense Type<span class="text-danger">*</span></h6>
											<div class="controls">
												<input type="text" value="{{$expenseType->expenseType}}" name="expenseType" class="form-control" required="">
								
											</div>
									</div>
						<div class="text-xs-right">
				<input type="submit" class="btn btn-rounded btn-primary mb-5" value="Update Expense Type">
									</div>
							</form>
						</div>
					</div>
