	  ...
	  <div class="col-lg-12 mb-lg-0 mb-4">
		<div class="card">
		  <div class="card-body p-3">
			...
			<form class="insert-form" id="insert_form" method="post" action="{{ route('requisition.store') }}">
			@csrf
			<div class="row">
				<div class="col">
					<div class="row mb-3">
			...
			<div class="container">
				<div class="row">
				  ...
				  <div class="col">
					<input type="submit" class="btn bg-gradient-primary w-100" value="Add Requisition">
				  </div>
				  <div class="col">
				  </div>
				</div>
