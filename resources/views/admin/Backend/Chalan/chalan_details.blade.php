			...
			<div class="row">
				<div class="col">
					<div class="row mb-3">
						...
						<div class="col">
							...
							<option value="" selected="" disabled="">{{$chalan->customer->customer_name}}</option>
				...
				<div class="col">
					<div class="row mb-3">
						...
						<div class="col"><input class="form-control" value="{{$chalan->chalan_date}}" type="date" id="saleDate" name="saleDate" required=""></div>
					</div>
					{{-- <div class="row mb-3">
