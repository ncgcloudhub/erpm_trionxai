	  ...
	  <div class="col-lg-12 mb-lg-0 mb-4">
		<div class="card">
		  <div class="card-body p-3">
			...
			<form class="insert-form" id="insert_form" method="post" action="{{ route('sales.update.store') }}">
			@csrf
				...
				<div class="col">
					<div class="row mb-3">
						...
						<div class="col">
							...
							<option value="{{$sale->student_id}}" selected="{{$sale->customer->user_name}}">{{$sale->customer->user_name}}</option>
						...
						<div class="row mb-3">
							...
							<div class="col"><input class="form-control" value="{{$sale->customer->address}}" type="text" id="address" name="address">
						</div>
							
						</div>
						<div class="row mb-3">
							<div class="col-3"><label class="text-uppercase text-dark text-xs font-weight-bold">Phone</label></div>
							<div class="col"><input value="{{$sale->customer->personal_phone}}" class="form-control mb-3" type="text" id="phone" name="phone"></div>
				...
				<hr>
					...
					<div class="col-4">
						...
						<div class="row mb-2">
							...
							<div class="col"><input value="{{$sale->tax}}" class="form-control" name="tax" type="text" id="tax">
							</div>
						</div>
						...
						<div class="row mb-2">
							...
							<div class="col"><input value="{{$sale->p_paid_amount}}" class="form-control" type="number" name="paidamount" id="paidamount">
							</div>
						</div>
						<div class="row mb-2">
