...
<div class="controls">
<input type="text" value="{{$student->student_name}}"  name="student_name" class="form-control" readonly > 
</div>
</div>
...
<div class="form-group">
    ...
    <div class="controls">
        <input type="date" value="{{$student->dob}}" name="dob" class="form-control" readonly>
    </div>
</div>
...
<div class="controls">
<input type="email" value="{{$student->email}}" name="email" class="form-control" readonly >
...
<div class="controls">
<input type="date" value="{{$student->enrolled_in}}" name="enrolled_in" class="form-control" readonly >
...
<div class="controls">
<input type="text" value="{{$student->phone}}" name="phone" class="form-control" readonly >
...
<div class="controls">
<input type="text" value="{{$student->address}}" name="address" class="form-control" readonly >
...
<div class="controls">
<input type="text" value="{{$student->city}}" name="city" class="form-control" readonly >
...
<div class="controls">
<input type="text" value="{{$student->state}}" name="state" class="form-control" readonly >
...
<div class="controls">
<input type="text" value="{{$student->zip}}" name="zip" class="form-control" pattern="\d{5}" title="Enter a valid 5-digit zip code" readonly >
...
<div class="controls">
<input type="text" value="{{$student->country}}" name="country" class="form-control" readonly >
