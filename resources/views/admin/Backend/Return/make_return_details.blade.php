			...
			<div class="row">
				<div class="col">
					<div class="row mb-3">
						...
						<div class="col">
							...
							<option value="{{$return->customer->id}}" selected="">{{$return->customer->customer_name}}</option>
						...
						<input class="form-control" value="{{$return->id
						}}" type="text" id="return_id" name="return_id" hidden>
	
						<div class="row mb-3">
							<div class="col-3"><label class="text-uppercase text-dark text-xs font-weight-bold">Address</label></div>
							<div class="col"><input class="form-control" value="{{$return->customer->address
						...
						<div class="row mb-3">
							...
							<div class="col"><input value="{{$return->customer->phone
				...
				<div class="col">
					<div class="row mb-3">
						...
						<div class="col"><input class="form-control" value="{{$return->return_date}}" type="date" id="returnDate" name="returnDate" required=""></div>
					</div>
					{{-- <div class="row mb-3">
					...
					<div class="row mb-3">
						...
						<div class="col"><textarea class="form-control" name="details" id="details" rows="1">{{$return->details}}</textarea></div>
					</div>
			...
			<div class="table-responsive">
				...
				<tr>
					<td>
					  ...
					  <td><input class="form-control qnty" value="{{$item->sold_qty}}" type="number" id="qnty" name="qnty[]" required=""></td>
					  <td><input class="form-control rqnty" value="{{$item->qty}}" type="number" id="rqnty" name="rqnty[]"></td>
