...
<div class="controls">
<input type="text" value="{{$supplier->vendor_name}}"  name="student_name" class="form-control" required > 
</div>
</div>
...
<div class="controls">
<input type="text" value="{{$supplier->vendor_s_name}}"  name="student_id" class="form-control"  > 
</div>
</div>
...
<div class="form-group">
    ...
    <div class="controls">
        <input type="text" value="{{$supplier->price}}" name="dob" class="form-control" required>
    </div>
</div>
...
<div class="controls">
<input type="text" value="{{$supplier->contact}}" name="enrolled_in" class="form-control" required >
