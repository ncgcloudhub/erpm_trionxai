		  ...
		  <div class="card-body p-3">
			<div class="row">
								  ...
								  <table id="example1" class="table table-bordered table-striped">
									<thead>
										<tr class="align-middle text-center">
											...
											<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Employee Type</th>
				 ...
				 <tr class="align-middle text-center text-sm">
					...
					<td class="text-start"><a href="{{ route('employee.view',$item->id) }}"><p class="mb-0 text-sm">{{ $item->f_name }} {{$item->l_name}}</p></a></td>
